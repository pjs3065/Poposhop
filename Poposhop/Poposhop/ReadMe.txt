================================================================================
    MFC 라이브러리 : Poposhop 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 Poposhop 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.

Poposhop 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Poposhop.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CPoposhopApp 응용 프로그램 클래스가 선언되어 있습니다.

Poposhop.cpp
    이는 응용 프로그램 클래스 CPoposhopApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
res\Poposhop.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 Poposhop.rc에 의해 포함됩니다.
...
PoposhopDoc.h, PoposhopDoc.cpp - 문서
    이 파일에는 CPoposhopDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CPoposhopDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.
    문서에는 다음과 같은 문자열이 있습니다.
        파일 확장명:      raw
        파일 형식 ID:        Poposhop.Document
        주 프레임 캡션:  Poposhop
        Doc 형식 이름:       Poposhop
        필터 이름:         Poposhop Files (*.raw)
        파일의 새 약식 이름: Poposhop
        파일 형식의 긴 이름: Poposhop.Document

PoposhopView.h, PoposhopView.cpp - 문서 뷰
    이 파일에는 CPoposhopView 클래스가 포함됩니다.
    CPoposhopView 개체는 CPoposhopDoc 개체를 보는 데 사용됩니다.

res\PoposhopDoc.ico
    아이콘 파일이며, CPoposhopDoc 클래스 MDII 자식 창의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 Poposhop.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 Poposhop.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.
